...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "economy_settings", "managed": True, "verbose_name": "Economy Settings", "verbose_name_plural": "Economy Settings"},
        ),
        migrations.CreateModel(
            name="BallSellPrice",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("ball", models.OneToOneField(help_text="The ball this price applies to.", on_delete=django.db.models.deletion.CASCADE, related_name="sell_price", to="bd_models.ball")),
            ...
            options={"db_table": "economy_ball_sell_price", "managed": True, "verbose_name": "Ball Sell Price", "verbose_name_plural": "Ball Sell Prices"},
        ),
        migrations.CreateModel(
            name="BallListing",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("seller", models.ForeignKey(help_text="The player who listed this ball.", on_delete=django.db.models.deletion.CASCADE, related_name="economy_listings", to="bd_models.player")),
                ("ball_instance", models.OneToOneField(help_text="The ball instance being listed.", on_delete=django.db.models.deletion.CASCADE, related_name="economy_listing", to="bd_models.ballinstance")),
                ...
                ("buyer", models.ForeignKey(blank=True, help_text="The player who bought this.", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="economy_purchases", to="bd_models.player")),
                ("sold_at", models.DateTimeField(blank=True, null=True)),
            ],
            options={"db_table": "economy_ball_listing", "managed": True, "verbose_name": "Ball Listing", "verbose_name_plural": "Ball Listings"},
        ),
        migrations.CreateModel(
            name="PassiveIncomePool",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("player", models.OneToOneField(help_text="The player this pool belongs to.", on_delete=django.db.models.deletion.CASCADE, related_name="economy_passive_pool", to="bd_models.player")),
            ...
            options={"db_table": "economy_passive_pool", "managed": True, "verbose_name": "Passive Income Pool", "verbose_name_plural": "Passive Income Pools"},
        ),
    ]
